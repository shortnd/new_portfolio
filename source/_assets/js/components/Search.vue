    ...
    <div class="flex flex-1 justify-end items-center text-right px-4">
        <div
            ...
            <input
                ...
                v-model="query"
                ref="search"
                class="transition-fast relative block h-10 w-full lg:w-1/2 lg:focus:w-3/4 bg-rouge border border-transparent focus:border-gold outline-none cursor-pointer text-gold px-4 pb-0"
            ...
            <button
                ...
                class="absolute pin-t pin-r h-10 font-light text-3xl text-gold hover:text-white focus:outline-none -mt-px pr-7 md:pr-3"
                @click="reset"
            >&times;</button>
        ...
        <button
            ...
            type="button"
            class="flex md:hidden bg-rouge justify-center items-center border border-rouge rounded-full focus:outline-none h-10 px-3"
