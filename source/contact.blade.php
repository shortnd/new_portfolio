...
@section('body')
    ...
    <form class="flex flex-col w-100" action="">
      <div class="mb-4">
        ...
        <input class="shadow px-2 py-3 border appearance-none rounded w-full leading-tight focus:outline-none focus:shadow-outline" type="text" name="name" id="name" placeholder="Name">
      </div>
      <div class="mb-4">
        <label class="mb-2 font-bold block font-lg text-grey-darker" for="email">Email:</label>
        <input class="shadow px-2 py-3 border appearance-none rounded w-full leading-tight focus:outline-none focus:shadow-outline" type="email" name="email" id="email" placeholder="Email">
      </div>
      <div class="mb-6">
        <label class="mb-2 font-bold block font-lg text-grey-darker w-full" for="message">Message:</label>
        <textarea class="shadow border appearance-none rounded w-full px-2 py-2 leading-tight resize-none focus:outline-none focus:shadow-outline" name="message" id="message" cols="30" rows="10" placeholder="Enter your message here"></textarea>
      </div>
      <div class="mb-6">
