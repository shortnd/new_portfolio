<a href="#main" id="skip" class="no-underline shadow-lg rounded text-gold bg-rouge fixed px-2 py-4" tabindex="0">SKIP TO
  CONTENT</a>
  ...
  <div class="container h-full flex items-center justify-between leading-tight sm:leading-loose mx-auto px-3 sm:px-12">
    ...
    <div class="h-full w-24 sm:w-auto flex flex-no-shrink flex-wrap sm:flex-no-wrap">
      ...
      <a href="mailto:ococncol@gmail.com"
        class="fill-current text-white fa fa-envelope text-2xl no-underline p-1 rounded bg-green bg-gold ml-2 mb-2">
      </a>
    </div>
  </div>
</header>
